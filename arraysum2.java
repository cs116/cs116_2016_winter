...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
        ...
        // 5. print sum of column 3
        System.out.println("Sum of column3: " + sumColumn(numbers, 3));
        
        // 6. print row with largest sum
        System.out.println("Row with largest sum is: " + largestRow(numbers));
    ...
    public static int sumColumn(int [][] array10, int column){
        int sum = 0;
        for(int i = 0; i < array10.length; i++){
            sum += array10[i][column];
            //System.out.print(array10[i][column] + " ");
        }
        return sum;
    } // end "sumColumn" method
    
    public static int largestRow(int [][] array10){
        int row = 0;
        int max = 0;
        for(int i = 0; i < array10.length; i++){
            int sum = 0;
            ...
            if (sum > max) {row = i; max = sum;}
        }
        return row;
    } // end "largestRow" method
